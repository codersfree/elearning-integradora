// resources/static/js/components/requirements/RequirementForm.template.js
...
<div class="card shadow-sm border-0 rounded-lg mt-4 bg-light">
    <div class="card-body p-4 p-md-5">
        ...
        <div class="text-end">
            <button type="button" class="btn btn-danger btn-lg px-4 me-2" @click="clearForm">Cancelar</button>
            <button type="button" class="btn btn-dark btn-lg px-4"
                    @click.prevent="handleSubmit()"
                    :disabled="newRequirementName.trim() === '' || isSubmitting">
